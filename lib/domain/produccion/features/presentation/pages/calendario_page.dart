...
class _CalendarioPageState extends State<CalendarioPage> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ...results.map(
            (ev) =>
                _buildEventTile(context, ev, showDivider: results.last != ev),
          ),
        ],
      ),
    );
  ...
  Widget _buildSelectedDayPanel(BuildContext context) {
    ...
    final dayLabel =
        '${_selected!.day} de ${_mn[_selected!.month]} ${_selected!.year}';
    return _Card(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        evs.isEmpty
                            ? 'Sin órdenes'
                            : '${evs.length} orden(es) con entrega',
                        style: const TextStyle(
                          color: AppColors.textSecondary,
                          fontSize: 11,
                        ),
                ...
                (row) => Row(
                  ...
                  children: List.generate(7, (col) {
                    ...
                    return GestureDetector(
                      onTap: () =>
                          setState(() => _selected = isS ? null : date),
                      child: SizedBox(
                        width: 36,
                        height: 44,
                        child: Column(
            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    Text(
                      '${_wd[_weekStart.weekday - 1]} ${_weekStart.day} — '
