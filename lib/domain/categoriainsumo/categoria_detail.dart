...
Future<void> showCategoriaDetail(BuildContext context, Categoria categoria) {
  return Navigator.of(context).push(
    PageRouteBuilder(
      opaque: false,
      barrierDismissible: true,
      pageBuilder: (ctx, animation, _) => _CategoriaDetailSheet(
        categoria: categoria,
        animation: animation,
      ),
    ),
...
class _CategoriaDetailSheet extends StatelessWidget {
  final Categoria categoria;
  final Animation<double> animation;

  const _CategoriaDetailSheet({required this.categoria, required this.animation});
        ...
        Align(
          ...
          child: SlideTransition(
            ...
            child: Material(
              ...
              child: Container(
                constraints: BoxConstraints(maxHeight: sh * 0.45),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(children: [
                        Container(width: 40, height: 40, decoration: BoxDecoration(color: _pink.withOpacity(0.12), borderRadius: BorderRadius.circular(12)), child: const Icon(Icons.label_outline, color: _pink, size: 22)),
                        const SizedBox(width: 10),
                        Expanded(child: Text(categoria.nombre, style: const TextStyle(color: _text, fontSize: 16, fontWeight: FontWeight.w800))),
                    ...
                    Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('ID: ${categoria.id}', style: const TextStyle(color: _grey, fontSize: 13)),
                        const SizedBox(height: 12),
                        const Text('Estado', style: TextStyle(color: Color(0xFF8E8E93), fontSize: 11, fontWeight: FontWeight.w600, letterSpacing: 0.5)),
                        const SizedBox(height: 6),
                        Row(children: [Container(width: 8, height: 8, decoration: BoxDecoration(color: categoria.isActivo ? _green : _red, shape: BoxShape.circle)), const SizedBox(width: 8), Text(categoria.estadoLabel, style: TextStyle(color: categoria.isActivo ? _green : _red, fontWeight: FontWeight.w700))])
                      ]),
                    ),
                    Padding(
